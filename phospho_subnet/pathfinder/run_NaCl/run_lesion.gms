...
* Maximize SI edges
*Free variable matchCount	"total match edges ";
*Equation countMatch	"count up active matched SI edges";
*countMatch .. matchCount =l= sum(motifmatchValueE(edge), x(edge));
...
* Minimize nodes within 1% - find one solution
